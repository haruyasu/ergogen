...
const kicad9 = require('../../src/templates/kicad9')
...
describe('Internals', function() {
    ...
    it('pcb outline conversion with kicad9', function() {
        // warn on unknown path type
        sinon.stub(m.model, 'walk').callsFake(function(model, config) {
            config.onPath({pathContext: {type: 'nonexistent'}})
        })
        kicad9.convert_outline.bind(this).should.throw("Can't convert path type")
    })
